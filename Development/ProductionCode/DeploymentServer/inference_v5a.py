...
model_path = 'RL_Honeypot_actorcrit_linux_ver30000_actor.keras'
...
def predict():
    ...
    # Uncomment to use DQN
    # agent = ddqn_agent_3x_simple_state_fnrfpr_v2.DoubleDeepQLearning(env, 0.99, 0.1, 200, normal_nodes, totalpermutation, 0.2, 0.14)
    # Uncomment to use A2C
    agent = a2c_3input.PPOAgent(env, 0.99, 0.1, 200, normal_nodes, totalpermutation, 0.2, 0.14)
