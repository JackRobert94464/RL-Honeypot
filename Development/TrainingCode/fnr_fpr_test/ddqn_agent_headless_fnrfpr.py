...
class DoubleDeepQLearning:
    ...
    def __init__(self,env,gamma,epsilon,numberEpisodes,nodecount,totalpermutation,fnr,fpr):
        ...
        # 24/04/2024 - False Negative and False Positive Rates
        self._fnr = fnr
        self._fpr = fpr
    ...
    def trainingEpisodes(self):
        ...
        for episode in range(self.numberEpisodes):
            ...
            while not self.env.is_last():
                ...
                print("Current state observation type: ", type(currentState.observation))
                ...
                print("Alerted observation type: ", type(alerted_observation))
                print("Alerted observation: ", alerted_observation)


                # os.system("pause")
                    
                
                action = self.selectAction(alerted_observation, episode)
